    ...
    <div class="container pt-5">
        <div class="card col-md-8 mx-auto">
            ...
            <form>
                ...
                <label class="col-md-3" for="candidateName">Candidate</label>
                    <input class="col-md-7" type="text" name="candidate_name" class="form-control" id="candidate_name" placeholder="Enter candidates name">
                </div>
                <center>
