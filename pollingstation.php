    ...
    <div class="container pt-5">
        <div class="card col-md-8 mx-auto">
            <div class="card-header" style="background:#034199; color:#fff;">
                <h4>Create Polling Station</h4>
            </div>
            <div class="card-body">
            <form>
                <div class="form-group col-md-10 mx-auto py-3">
                    <label class="col-md-3" for="regionName">Polling Station</label>
                    <input class="col-md-7" type="text" name="pollstation_name" class="form-control" id="pollstation_name" placeholder="Enter polling station name">
                </div>
