        ...
        <div class="card col-md-8 mx-auto">
            ...
            <form>
                <div class="form-group col-md-10 mx-auto my-4">
                    <label class="col-md-3" for="regionName">Region</label>
                    <input class="col-md-7" type="text" name="region_name" class="form-control" id="region_name" placeholder="Enter region name">
                </div>
                <center>
